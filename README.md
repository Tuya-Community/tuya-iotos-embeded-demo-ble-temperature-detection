...
This demo is based on the Tuya Smart Cloud Platform, Tuya Smart App, IoTOS Embeded Ble SDK, using Tuya BLE  series modules to quickly build atemperature detection demo based on the TLSR8253 chip platform, with real-time temperature monitoring.
...
| tuya_app_adc.c | adc-related code |
| tuya_app_adc.h | header file |
| tuya_temp_check.c | temperature_check_demo_logic |
| tuya_temp_check.h | header file |
