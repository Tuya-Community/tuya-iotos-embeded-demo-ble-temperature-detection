...
本 Demo 基于涂鸦智能云平台、涂鸦智能APP、IoTOS Embeded Ble SDK，使用涂鸦BLE系列模组快速组建一个基于TLSR8253芯片平台的温度检测demo，具有实时监测温度的功能。
...
|        tuya_app_adc.c            |                       adc 相关代码                         |
|        tuya_app_adc.h            |                           头文件                            |
|       tuya_temp_check.c          |                   温度检测demo逻辑                    |
|       tuya_temp_check.h          |                           头文件                            |
